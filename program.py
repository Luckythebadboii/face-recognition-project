...
lucky_image = face_recognition.load_image_file("photos\mypic.png")
lucky_encoding = face_recognition.face_encodings(lucky_image)[0]
...
sunny_encoding = face_recognition.face_encodings(sunny_image)[0]
